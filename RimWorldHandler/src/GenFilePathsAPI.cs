...
namespace RimWorldHandler {
    ...
    public static class GenFilePathsAPI {
        ...
        public static string FolderUnderSaveData(string folder) {
            return (string)typeof(GenFilePaths).GetMethod("FolderUnderSaveData", BindingFlags.NonPublic | BindingFlags.Static).Invoke(null, new object[] { folder });
        }
    }
}